# Это репозиторий для того что бы откатывать мою настройку startpage при багах.
Вот ссылка на оригинальный репозиторий - [tartarus-startpage](https://github.com/AllJavi/tartarus-startpage)
